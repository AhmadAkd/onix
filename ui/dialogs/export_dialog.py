...
class ExportDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        # Description
        desc_label = QLabel(self.tr("Server List: Basic server information\nHealth Stats: Includes ping data and health check results"))
        ...
        self.export_button = QPushButton(QIcon(":/icons/file-text.svg"), self.tr("Export"))
    ...
    def export_data(self):
        ...
        try:
            ...
            if self.button_group.checkedId() == 0:
                # Server list only
                filepath = ExportService.export_server_list_to_csv(self.servers, filename)
