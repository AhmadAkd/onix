...
class TestServerManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.settings = {
            "servers": {
                "group1": [
                    {"id": "1", "name": "server1", "ping": 100, "group": "group1", "server": "a", "port": 1},
                    {"id": "2", "name": "server2", "ping": 200, "group": "group1", "server": "b", "port": 2},
                ]
            },
            "subscriptions": []
        }
    ...
    def test_load_servers_with_migration(self):
        ...
        with patch('managers.server_manager.settings_manager.save_settings') as mock_save:
    ...
    def test_add_manual_server(self, mock_parse_server_link):
        ...
        self.server_manager.add_manual_server("vless://...", group_name="group2", update_ui=True)
    ...
    def test_sort_servers_by_ping(self):
        ...
        sorted_names = [s["name"] for s in self.server_manager.get_servers_by_group("group1")]
