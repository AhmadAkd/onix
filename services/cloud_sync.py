...
class CloudSyncService:
    ...
    def _upload_item(self, item: SyncItem) -> bool:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log(
                    f"Failed to upload item {item.id}: {response.status_code}",
                    LogLevel.WARNING,
                )
                return False
    ...
    def _download_updates(self) -> None:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                self.log(
                    f"Failed to download updates: {response.status_code}",
                    LogLevel.WARNING,
                )
    ...
    def _handle_conflict(
        self, local_item: SyncItem, remote_item: Dict[str, Any]
    ) -> None:
        ...
        try:
            ...
            self.log(
                f"Sync conflict detected for item {local_item.id}", LogLevel.WARNING
            )
    ...
    def _apply_remote_update(
        self, remote_item: Dict[str, Any], decrypted_data: Dict[str, Any]
    ) -> None:
        ...
        try:
            ...
            self.log(
                f"Applied remote update for item {remote_item['id']}", LogLevel.DEBUG
            )
