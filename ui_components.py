...
def handle_text_shortcut(widget, action):
    ...
    try:
        ...
        if action == 'cut':
            ...
            elif hasattr(tk_widget, 'delete') and hasattr(tk_widget, 'get') and hasattr(tk_widget, 'clipboard_clear') and hasattr(tk_widget, 'clipboard_append'):
                try:
            ...
            elif hasattr(tk_widget, 'get') and hasattr(tk_widget, 'clipboard_clear') and hasattr(tk_widget, 'clipboard_append'):
                try:
                    selected_text = tk_widget.get(tkinter.SEL_FIRST, tkinter.SEL_LAST)
                    tk_widget.clipboard_clear()
                    tk_widget.clipboard_append(selected_text)
            ...
            try:
                ...
                if tk_widget.tag_ranges("sel"): # If there's a selection, delete it first
                    tk_widget.delete(tkinter.SEL_FIRST, tkinter.SEL_LAST)
